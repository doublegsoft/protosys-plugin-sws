 ...
 * @since 1.0.0
 */
public class ${java.nameType(module)}DataControllerTest extends TestBase {
...
<#list apis as api>
     ...
     */
    @Ignore
    public void test_${h.method(api.name)}() throws Exception {
        ${java.nameType(module)}DataController controller = new ${java.nameType(module)}DataController();
