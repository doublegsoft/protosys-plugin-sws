 ...
 * @since 1.0.0
 */
public class ${java.nameType(module)}ViewControllerTest extends TestBase {
...
<#list apis as api>
     ...
     */
    @Ignore
    public void test_viewFor${java.nameType(api.model.page)}() throws Exception {
        ${java.nameType(module)}ViewController controller = new ${java.nameType(module)}ViewController();
...
<#list api.model.parameters as param>
        ...
        controller.viewFor${java.nameType(api.model.page)}(criteria);
    }
